...
newsletterName: "Anna-Md.",
newsletterJid: "242067712688@newsletter",
},
"externalAdReply": {
...
async function Telesticker(url) {
    ...
    resolve(mariayresult)
        ...
        if (autobio) {
            Maria.updateProfileStatus(`Anna-Md by SatoruTech t.me/satorutech ${runtime(process.uptime())} `).catch(_ => _)
        }
...
if (!verificationBot) {
m.reply(`⛩️ *❯─「 Anna-Md 」─❮* ⛩️\n
𝙹𝚘𝚒𝚗 𝚘𝚞𝚛 channel 𝚝𝚘 𝚒𝚗𝚝𝚎𝚛𝚊𝚌𝚝 𝚠𝚒𝚝𝚑 Anna-Md 🌟 \n\n https://www.whatsapp.com/channel/0029Vanj84h6rsQmGlOrMz1X`);
return;
}
...
const mariafeature = () =>{
            var mytext = fs.readFileSync("./Anna-Md.js").toString()
...
break;
  ...
  const slides = [
    [
        ...
        '', // Title
        `Anna-Md YOUTUBE CHANNEL `, // Body message
        botname, // Footer message
        'Visit', // Button display text
        'https://youtube.com/@SatoruTech', // Command (URL in this case)
        'cta_url', // Button type
        'https://youtube.com/@SatoruTech' // URL (used in image generation)
    ], 
        ...
        jid,
        {
            viewOnceMessage: {
                message: {
                  ...
                  isForwarded: true,
                forwardedNewsletterMessageInfo: {
                  newsletterJid: '242067712688@s.whatsapp.net',
...
sendSlide(m.chat, 'Anna-Md', 'Here the Anna-Md deploy tutorial', botname, slides);
}
break
...
break;
                ...
                for (let i of anu) {
                    ...
                    Maria.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                showAdAttribution: true,
                                title: 'Anna-Md 𝙱𝚁𝙾𝙰𝙳𝙲𝙰𝚂𝚃',
                                body: `Sent ${i.length} Group`,
                               thumbnailUrl: 'https://imgs.search.brave.com/i_IAh5x3sVM0KdWYc-ecCeMeH4tynGpp34j4RKEk-VY/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzLzU1L2Vm/LzIxLzU1ZWYyMTJk/ZWEzNDY1NzQ1MWY3/NWYxZjI3YmFjOTY3/LmpwZw',
            ...
            case 'getcase':
                if (!isCreator) return reply(mess.owner)
                const getCase = (cases) => {
                    return "case" + `'${cases}'` + fs.readFileSync("Anna-Md.js").toString().split('case \'' + cases + '\'')[1].split("break;")[0] + "break;"
                }
                reply(`${getCase(q)}`)
                break;
            case 'delete':
...
const axios = require("axios");
let repoInfo = await axios.get("https://api.github.com/repos/SatoruTech/Anna-Md");
        let repo = repoInfo.data;
        console.log(repo);

   const scritxt = `*Anna-Md*\n
  *🌟 Creator:* SatoruTech\n
  *🌟 Repo:* ${repo.html_url}\n
    ...
    if (/image/.test(mime)) {
        ...
        try {
            ...
            let encmedia = await Maria.sendVideoAsSticker(m.chat, media, m, {
                packname: global.stickername || 'Anna-Md',
            });
            await fs.unlinkSync(encmedia);
        } catch (error) {
...
break;
            case 'toimage':
            case 'toimg': {
                if (!/webp/.test(mime)) return reply(`🍭𝑹𝒆𝒑𝒍𝒚 𝒔𝒕𝒊𝒄𝒌𝒆𝒓 𝒘𝒊𝒕𝒉 𝒄𝒂𝒑𝒕𝒊𝒐𝒏 ${prefix + command} *Anna-Md*`)
                reply(mess.wait)
                let media = await Maria.downloadAndSaveMediaMessage(qmsg)
            ...
            break;
            case 'checkdeath':
             if (!text) return replay(`Use Someone's Name, Example : ${prefix + command} *Anna-Md*`)
...
case 'chatgpt':
  ...
  break;
   ...
   /////////////////////////////////////_//////////////
        ...
        const helptxt = `📍𝗪𝗔𝗥𝗡📍\n\n\n*>>>* *use* *${prefix}support to get the Official group link in your dm.*\n\n*--->* *If you want to add Anna-Md in your group the contact the owner by* *${prefix}owner/${prefix}mods* \n\n*--->* *Dont use wrong command, use the command given in the* *${prefix}help* *list* \n\n* *Dont spam the bot with commands if Anna-Md is not responding, its means the maybe owner is offline or facing internet issue.* \n\n*IF YOU DONT FOLLOW THE RULES THEN YOU WILL BE BANNED* 🚫 \n\n\n*©️ 𝐓𝐎𝐆𝐄_𝐁𝐎𝐓 𝐈𝐧𝐜* `
      ...
      case 'toge':
        ...
        let txxt = `𝚑𝚎𝚕𝚕𝚘 ${pushname} 𝙸 𝚊𝚖 Anna-Md 𝚊 𝚆𝚑𝚊𝚝𝚜𝙰𝚙𝚙 𝚋𝚘𝚝 𝚍𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚍 𝚋𝚢 SatoruTech 𝚑𝚘𝚠 𝚌𝚊𝚗 𝙸 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚋𝚊𝚋𝚢 ?`

        Maria.sendMessage(m.chat, { image: { url: "https://imgs.search.brave.com/i_IAh5x3sVM0KdWYc-ecCeMeH4tynGpp34j4RKEk-VY/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzLzU1L2Vm/LzIxLzU1ZWYyMTJk/ZWEzNDY1NzQ1MWY3/NWYxZjI3YmFjOTY3/LmpwZw" }, caption: txxt}, { quoted: m });
      ...
      case "info":
            Maria.sendMessage(from, { react: { text: "", key: m.key }}) 
        let pifx = `✦ ───『 𝙸𝚗𝚏𝚘 𝚍𝚎𝚟 』─── ⚝\n\n\n◈𝐆𝐈𝐓𝐇𝐔𝐁:https://github.com/SatoruTech\n\n◈𝐘𝐎𝐔𝐓𝐔𝐁𝐄:https://youtube.com/SatoruTech?si=FQ1JoEiF0T7ve-6W\n\n◈𝐒𝐔𝐏𝐏𝐎𝐑𝐓 Channel:https://www.whatsapp.com/channel/0029Vanj84h6rsQmGlOrMz1X\n\n◈𝐆𝐑𝐎𝐔𝐏 𝐅𝐎𝐑 `
...
> 💻 *Sᴏᴜʀᴄᴇ Cᴏᴅᴇ :* https://github.com/SatoruTech/Anna-Md
> 💨 *YᴏᴜTᴜʙᴇ :* https://youtube.com/@SatoruTech
> 🔮 *Public Channel :* https://www.whatsapp.com/channel/0029Vanj84h6rsQmGlOrMz1X
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
                             {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝙱𝙰𝙲𝙺","id":"${prefix}list"}`
   },
...
let msg = generateWAMessageFromContent(from, {
  ...
  "buttonParamsJson": `{"display_text":"𝗠𝗘𝗡𝗨","id":"${prefix}menu"}`
                 ...
                 {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗠𝗘𝗡𝗨 𝗟𝗜𝗦𝗧","id":"${prefix}list"}`
   },
                 {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥","id":"${prefix}developer"}`
   },
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          ...
          nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
            buttons: [
                            {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗔𝗟𝗟 𝗠𝗘𝗡𝗨","id":"${prefix}menu"}`
   },
                 {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗚𝗘𝗡𝗘𝗥𝗔𝗟","id":"${prefix}generalmenu"}`
   },
                 {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗘𝗗𝗨𝗖𝗔𝗧𝗜𝗢𝗡","id":"${prefix}educationmenu"}`
   },

                 {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗖𝗢𝗗𝗜𝗡𝗚","id":"${prefix}codingmenu"}`
   },
                 {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗢𝗪𝗡𝗘𝗥","id":"${prefix}ownermenu"}`
   },
   {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗚𝗥𝗢𝗨𝗣","id":"${prefix}groupmenu"}`
   },
   {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗙𝗨𝗡","id":"${prefix}funmenu"}`
   },
   {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗","id":"${prefix}downloadmenu"}`
   },
   {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗪𝗔𝗟𝗟𝗣𝗔𝗣𝗘𝗥","id":"${prefix}wallmenu"}`
   },
   {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗦𝗡𝗔𝗣𝗕𝗟𝗘𝗡𝗗","id":"${prefix}snapblendmenu"}`
   },
   {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗢𝗧𝗛𝗘𝗥𝗦","id":"${prefix}othersmenu"}`
   },
   {
  "name": "quick_reply",
  "buttonParamsJson": `{"display_text":"𝗚𝗔𝗠𝗘𝗦","id":"${prefix}Gamemenu"}`
   },
              {
                 "name": "cta_url",
                 "buttonParamsJson": "{\"display_text\":\"𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣\",\"url\":\"https://whatsapp.com/channel/0029VaiuD4s4IBhI0fzbv40Z\",\"merchant_url\":\"https://www.google.com\"}"
     ...
     case 'pme':
{
    ...
    if (sender !== '242067712688@s.whatsapp.net') return reply('Ahh, only my Darling Anna can access this command...');
...
case 'dme':
{
    ...
    if (sender !== '242067712688@s.whatsapp.net') return reply('Ahh, only my owner can use this command ');
    // if (!isBotGroupAdmins) return reply('Bot Not Admin...');
...
if (!text) return reply(`🧩Where is the link?\nExample :\n${prefix}${command} https://github.com/Anna/Anna-Md `)
...
if (!q) return reply(`Example : ${prefix+command} Anna`) 
let link
...
case 'developer':
case 'dev':
    const devmod = `𝚑𝚒 𝚖𝚢 𝚍𝚎𝚟𝚎𝚕𝚘𝚙𝚎𝚛 𝚒𝚜 SatoruTech 𝚑𝚎𝚛𝚎 𝚊𝚛𝚎 𝚝𝚑𝚎𝚒𝚛 𝚗𝚞𝚖𝚋𝚎𝚛𝚜 @242067712688`;

    Maria.sendMessage(m.chat, { text: devmod, mentions: ["242067712688@s.whatsapp.net", "242067712688@s.whatsapp.net", "242067712688@s.whatsapp.net","242067712688@s.whatsapp.net"] }, { quoted: m });
    break;
...
case 'dice': {
    ...
    if (isNaN(userNumber) || userNumber < 1 || userNumber > 6) {
        ...
        if (playerNumber > mariaNumber) {
            resultMessage = `🎲 You chose ${playerNumber}! Anna-Md rolled a ${mariaNumber}. 🏆 You win! 🎉`;
        } else if (playerNumber < mariaNumber) {
            resultMessage = `🎲 You chose ${playerNumber}! Anna-Md rolled a ${mariaNumber}. 😞 You lose! 💔`;
        } else {
            resultMessage = `🎲 You chose ${playerNumber}! Anna-Md rolled a ${mariaNumber}. 🤝 It's a tie! 😅`;
        }
...
case 'poker': {
    ...
    function playPoker() {
        ...
        resultMessage += `*Anna-Md*'s Hand: ${mariaHand[0]}, \n`;
        resultMessage += `\t\t---------------------------------\n`;
...
❁ ═════ ❃•📑 *GITHUB* 📑•❃ ═════ ❁
*_LINK:-_* https://github.com/SatoruTech/Anna-Md
...
📝 Note: Beware of fake Anna-Md bots! People may falsely claim to represent Anna-Md. Please exercise caution.
