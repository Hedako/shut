...
**TOGE-MD-V3 is a multi-device bot that can help you with different things on WhatsApp developed by [TOGE INUMAKI](https://github.com/Anna)**
...
1. Must Fork This Repo Before Deployment !
   <br> 
<a href="https://github.com/Anna/TOGE-MD-V3/fork"><img title="FORK REPO" src="https://img.shields.io/badge/FORK REPO-h?color=black&style=for-the-badge&logo=stackshare"></a>
...
2. Now Deploy
    <br>
<a href='https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FAnna%2FTOGE-V3-AI%3Ftab%3Dreadme-ov-file&template=https%3A%2F%2Fgithub.com%2FAnna%2FTOGE-V3-AI%3Ftab%3Dreadme-ov-file' target="_blank"><img alt='DEPLOY' src='https://img.shields.io/badge/-DEPLOY-black?style=for-the-badge&logo=heroku'/></a>
...
2. Now Deploy
    <br>
<a href='https://replit.com/github/Anna/TOGE-MD-V3' target="_blank"><img alt='DEPLOY' src='https://img.shields.io/badge/-IMPORT-black?style=for-the-badge&logo=replit'/></a>
##
### Termux/Ssh/Ubuntu
...
git clone https://github.com/Anna/TOGE-V3-AI
cd TOGE-V3-AI
yarn install
npm start
```
  ...
  ***- Using download method to local storage.***
  ...
  Step: 1
    ***Download [`TOGE-V3-AI`](https://github.com/Anna/TOGE-V3-AI/archive/refs/heads/Master.zip) repository first.***
...
```
 ...
 ## `Main Dev` 
<a href="https://github.com/Anna"><img src="https://github.com/Anna.png" width="250" height="250" alt="Anna"/></a>
